...
\*        );
        assert (\A x \in 1..Len(input) : 
        (input[x] = target) => ((~(\E y \in 1..x-1 : y = x))/\ ( x = target)));
    
    }
}
*)
\* BEGIN TRANSLATION (chksum(pcal) = "1cef40f4" /\ chksum(tla) = "7ab0aef2")
...
\* Last modified Sat Mar 04 23:45:55 EST 2023 by jorra04
