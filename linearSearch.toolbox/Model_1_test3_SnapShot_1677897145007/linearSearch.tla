...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "2af18771" /\ chksum(tla) = "fc5d9e95")
...
Lbl_2 == /\ pc = "Lbl_2"
         /\ IF i <= Len(input)
               THEN /\ IF input[i] = target
                    ...
                    /\ i' = i + 1
                    /\ pc' = "Lbl_2"
               ELSE /\ Assert((\A x \in 1..Len(input) : (input[x] = target) => x = index), 
...
\* Last modified Fri Mar 03 21:31:56 EST 2023 by jorra04
