...
--algorithm getAllSuffixes_v2 {
    ...
    
    {
        ...
        *)
        ...
        (\A y \in 1..Len(allSuffixes[x]) : (allSuffixes[x][y] = input[x]))
        );
    }
}
*)
\* BEGIN TRANSLATION (chksum(pcal) = "1107893b" /\ chksum(tla) = "6ac201ad")
...
\* Last modified Sun Mar 05 01:21:07 EST 2023 by jorra04
