...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "a68fddf8" /\ chksum(tla) = "9cc6411f")
...
Lbl_4 == /\ pc = "Lbl_4"
         /\ IF j <= Len(temp2)
               THEN /\ output' = output \o <<temp2[j]>>
                    /\ j' = j + 1
                    /\ pc' = "Lbl_4"
               ELSE /\ Assert((\A a \in 1..Len(output) : \E b \in a..Len(output) : (output[b] % 3 # output[a] % 3) => (output[b] % 3 >= output[a] % 3) ), 
                              "Failure of assertion at line 68, column 11.")
                    /\ pc' = "Done"
                    /\ UNCHANGED << output, j >>
         /\ UNCHANGED << numberOfMultiplesOf3, numberOfMultiplesOf3Plus1, 
                         numberOfMultiplesOf3Plus2, temp0, temp1, temp2, i, 
...
\* Last modified Sat Apr 01 22:20:13 EDT 2023 by jorra04
