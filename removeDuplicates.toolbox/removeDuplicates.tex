...
\fl{}\moduleLeftDash\cl{ {\MODULE} removeDuplicates}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Integers ,\, Sequences ,\, TLC}
\fl{ {\CONSTANT} input}
\fl{}
\fl{}
\fl{ {\p@mmalgorithm} removeDuplicates {\p@lbrace}}
\fl{}
\fl{ {\p@variable} output \.{=} {\langle} {\rangle} ,\,}
\fl{ i \.{=} 1 ,\,}
\fl{ j \.{=} 1 ,\,}
\fl{ itemFound \.{=} {\FALSE} {\p@semicolon}}
\fl{}
\fl{ {\p@lbrace}}
\fl{ {\p@while} {\p@lparen} i \.{\leq} Len ( input ) {\p@rparen} {\p@lbrace}}
\fl{ {\p@while} {\p@lparen} j \.{\leq} Len ( output ) {\p@rparen} {\p@lbrace}}
 \fl{ {\p@if} {\p@lparen}}\al{15}{2}{ input [ i ] \.{=} output [ j ]
 {\p@rparen} {\p@lbrace}}
\fl{ itemFound \.{:=} {\TRUE} {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{ j \.{:=} j \.{+} 1 {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
 \fl{ {\p@if} {\p@lparen}}\al{20}{2}{ itemFound \.{\neq} {\TRUE} {\p@rparen}
 {\p@lbrace}}
\fl{ output \.{:=} Append ( output ,\, input [ i ] ) {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{ itemFound \.{:=} {\FALSE} {\p@semicolon}}
\fl{}
\fl{ i \.{:=} i \.{+} 1 {\p@semicolon}}
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{}
 \fl{ {\p@assert} ( \A\, x \.{\in} 1 \.{\dotdot} Len ( input ) \.{:} ( \A\, y
 \.{\in} 1 \.{\dotdot} Len ( input ) \.{:}}
\fl{ {\IF} x \.{\neq} y}
\fl{ \.{\THEN} 1}\al{30}{2}{ \.{=}}\al{30}{3}{ 1}
\fl{ \.{\ELSE} 1}\al{31}{2}{ \.{=}}\al{31}{3}{ 2 ) ) {\p@semicolon}}
\fl{}
\fl{ {\p@rbrace}}
\fl{}
\fl{ {\p@rbrace}%
...
\fl{}
\fl{}
\fl{ {\VARIABLES} output ,\, i ,\, j ,\, itemFound ,\, pc}
\fl{}
 \fl{ vars}\al{40}{1}{ \.{\defeq} {\langle} output ,\, i ,\, j ,\, itemFound
 ,\, pc {\rangle}}
\fl{}
\fl{ Init}\al{42}{1}{ \.{\defeq}}\al{42}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
\fl{ \.{\land}}\al{43}{1}{ output \.{=} {\langle} {\rangle}}
\fl{ \.{\land}}\al{44}{1}{ i}\al{44}{2}{ \.{=}}\al{44}{3}{ 1}
\fl{ \.{\land}}\al{45}{1}{ j}\al{45}{2}{ \.{=}}\al{45}{3}{ 1}
\fl{ \.{\land}}\al{46}{1}{ itemFound \.{=} {\FALSE}}
\fl{ \.{\land}}\al{47}{1}{ pc \.{=}\@w{Lbl\_1}}
\fl{}
 \fl{ Lbl\_1}\al{49}{1}{ \.{\defeq}}\al{49}{2}{ \.{\land}}\al{49}{3}{ pc
 \.{=}\@w{Lbl\_1}}
\fl{ \.{\land}}\al{50}{1}{ {\IF}}\al{50}{2}{ i \.{\leq} Len ( input )}
\fl{ \.{\THEN}}\al{51}{1}{ \.{\land}}\al{51}{2}{ pc \.{'} \.{=}\@w{Lbl\_2}}
 \fl{ \.{\ELSE}}\al{52}{1}{ \.{\land}}\al{52}{2}{ Assert}\al{52}{3}{ ( ( \A\,
 x \.{\in} 1 \.{\dotdot} Len ( input ) \.{:} ( \A\, y \.{\in} 1 \.{\dotdot}
 Len ( input ) \.{:}}
\fl{ {\IF} 1 \.{=} 1}
\fl{ \.{\THEN} 1}\al{54}{2}{ \.{=}}\al{54}{3}{ 1}
\fl{ \.{\ELSE} 1}\al{55}{2}{ \.{=}}\al{55}{3}{ 2 ) ) ,\,}
\fl{\@w{Failure\ of\ assertion\ at\ line\ 29,\ column\ 9.} )}
\fl{ \.{\land}}\al{57}{1}{ pc \.{'} \.{=}\@w{Done}}
 \fl{ \.{\land}}\al{58}{1}{ {\UNCHANGED} {\langle} output ,\, i ,\, j ,\,
 itemFound {\rangle}}
\fl{}
 \fl{ Lbl\_2}\al{60}{1}{ \.{\defeq}}\al{60}{2}{ \.{\land}}\al{60}{3}{ pc
 \.{=}\@w{Lbl\_2}}
\fl{ \.{\land}}\al{61}{1}{ {\IF}}\al{61}{2}{ j \.{\leq} Len ( output )}
 \fl{ \.{\THEN}}\al{62}{1}{ \.{\land}}\al{62}{2}{ {\IF}}\al{62}{3}{ input [ i
 ] \.{=} output [ j ]}
 \fl{ \.{\THEN}}\al{63}{1}{ \.{\land}}\al{63}{2}{ itemFound \.{'} \.{=}
 {\TRUE}}
\fl{ \.{\ELSE}}\al{64}{1}{ \.{\land}}\al{64}{2}{ {\TRUE}}
\fl{ \.{\land}}\al{65}{1}{ {\UNCHANGED} itemFound}
\fl{ \.{\land}}\al{66}{1}{ j \.{'} \.{=} j \.{+} 1}
\fl{ \.{\land}}\al{67}{1}{ pc \.{'} \.{=}\@w{Lbl\_2}}
\fl{ \.{\land}}\al{68}{1}{ {\UNCHANGED} {\langle} output ,\, i {\rangle}}
 \fl{ \.{\ELSE}}\al{69}{1}{ \.{\land}}\al{69}{2}{ {\IF}}\al{69}{3}{ itemFound
 \.{\neq} {\TRUE}}
 \fl{ \.{\THEN}}\al{70}{1}{ \.{\land}}\al{70}{2}{ output \.{'} \.{=} Append (
 output ,\, input [ i ] )}
\fl{ \.{\ELSE}}\al{71}{1}{ \.{\land}}\al{71}{2}{ {\TRUE}}
\fl{ \.{\land}}\al{72}{1}{ {\UNCHANGED} output}
\fl{ \.{\land}}\al{73}{1}{ itemFound \.{'} \.{=} {\FALSE}}
\fl{ \.{\land}}\al{74}{1}{ i \.{'} \.{=} i \.{+} 1}
\fl{ \.{\land}}\al{75}{1}{ pc \.{'} \.{=}\@w{Lbl\_1}}
\fl{ \.{\land}}\al{76}{1}{ j \.{'} \.{=} j}
\fl{}
\fl{}
\fl{ Terminating \.{\defeq} pc \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars}
\fl{}
 \fl{ Next}\al{81}{1}{ \.{\defeq}}\al{81}{2}{ Lbl\_1}\al{81}{3}{ \.{\lor}
 Lbl\_2}
\fl{ \.{\lor}}\al{82}{1}{ Terminating}
\fl{}
 \fl{ Spec}\al{84}{1}{ \.{\defeq}}\al{84}{2}{ Init \.{\land} {\Box} [ Next ]_{
 vars}}
\fl{}
