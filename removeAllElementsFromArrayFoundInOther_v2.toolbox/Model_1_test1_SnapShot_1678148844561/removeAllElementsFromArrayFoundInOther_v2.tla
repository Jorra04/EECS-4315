...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "20891e9" /\ chksum(tla) = "39fb99ff")
...
Lbl_3 == /\ pc = "Lbl_3"
         /\ IF i <= Len(input1)
               ...
               ELSE /\ Assert(     (\A x \in 1..Len(output) :
                              ...
                              "Failure of assertion at line 31, column 7.")
                    /\ Assert(       (\A x \in 1..Len(output) :
                              ~(\E y \in 1..Len(input2) : output[x] = input2[y])
                              ), 
...
\* Last modified Mon Mar 06 19:26:29 EST 2023 by jorra04
