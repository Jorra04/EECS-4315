...
\fl{}\moduleLeftDash\cl{ {\MODULE} twoSum}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Integers ,\, Sequences ,\, TLC}
\fl{ {\CONSTANT} input ,\, target}
\fl{}
\fl{}
\fl{}
\fl{ {\p@mmalgorithm} twoSum {\p@lbrace}}
\fl{}
...
\fl{ j \.{:=} i \.{+} 1 {\p@semicolon}}
\fl{ {\p@while} {\p@lparen} j \.{\leq} Len ( input ) {\p@rparen} {\p@lbrace}}
 \fl{ {\p@if} {\p@lparen} (}\al{16}{3}{ i \.{\neq} j ) \.{\land} ( ( input [ i
 ] \.{+} input [ j ] ) \.{=} target ) {\p@rparen} {\p@lbrace}}
 \fl{ output \.{:=} output \.{\circ} {\langle} i ,\, j {\rangle}
 {\p@semicolon}}
...
\fl{ {\p@rbrace} {\p@semicolon}}
\fl{}
\fl{ {\p@assert} ( \A\, x \.{\in} 1 \.{\dotdot} Len ( input ) \.{:}}
\fl{ ( \A\, y \.{\in} 1 \.{\dotdot} Len ( input ) \.{:}}
 \fl{ ( ( x \.{\neq} y ) \.{\land} ( input [ x ] \.{+} input [ y ] \.{=}
 target ) ) \.{\implies} ( ( {\langle} x ,\, y {\rangle} \.{=} output )
 \.{\lor} ( {\langle} y ,\, x {\rangle} \.{=} output ) )}
\fl{ ) ) {\p@semicolon}}
\fl{ {\p@rbrace}}
\fl{ {\p@rbrace}%
\@y{}%
...
\fl{}
\fl{}
\fl{ {\VARIABLES} output ,\, i ,\, j ,\, pc}
\fl{}
 \fl{ vars}\al{35}{1}{ \.{\defeq} {\langle} output ,\, i ,\, j ,\, pc
 {\rangle}}
\fl{}
\fl{ Init}\al{37}{1}{ \.{\defeq}}\al{37}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
\fl{ \.{\land}}\al{38}{1}{ output \.{=} {\langle} {\rangle}}
\fl{ \.{\land}}\al{39}{1}{ i}\al{39}{2}{ \.{=}}\al{39}{3}{ 1}
\fl{ \.{\land}}\al{40}{1}{ j}\al{40}{2}{ \.{=}}\al{40}{3}{ 1}
\fl{ \.{\land}}\al{41}{1}{ pc \.{=}\@w{Lbl\_1}}
\fl{}
 \fl{ Lbl\_1}\al{43}{1}{ \.{\defeq}}\al{43}{2}{ \.{\land}}\al{43}{3}{ pc
 \.{=}\@w{Lbl\_1}}
\fl{ \.{\land}}\al{44}{1}{ {\IF}}\al{44}{2}{ i \.{\leq} Len ( input )}
\fl{ \.{\THEN}}\al{45}{1}{ \.{\land}}\al{45}{2}{ j \.{'} \.{=} i \.{+} 1}
\fl{ \.{\land}}\al{46}{1}{ pc \.{'} \.{=}\@w{Lbl\_2}}
 \fl{ \.{\ELSE}}\al{47}{1}{ \.{\land}}\al{47}{2}{ Assert}\al{47}{3}{ ( ( \A\,
 x \.{\in} 1 \.{\dotdot} Len ( input ) \.{:}}
\fl{ ( \A\, y \.{\in} 1 \.{\dotdot} Len ( input ) \.{:}}
 \fl{ ( ( x \.{\neq} y ) \.{\land} ( input [ x ] \.{+} input [ y ] \.{=}
 target ) ) \.{\implies} ( ( {\langle} x ,\, y {\rangle} \.{=} output )
 \.{\lor} ( {\langle} y ,\, x {\rangle} \.{=} output ) )}
\fl{ ) ) ,\,}
\fl{\@w{Failure\ of\ assertion\ at\ line\ 26,\ column\ 9.} )}
\fl{ \.{\land}}\al{52}{1}{ pc \.{'} \.{=}\@w{Done}}
\fl{ \.{\land}}\al{53}{1}{ j \.{'} \.{=} j}
\fl{ \.{\land}}\al{54}{1}{ {\UNCHANGED} {\langle} output ,\, i {\rangle}}
\fl{}
 \fl{ Lbl\_2}\al{56}{1}{ \.{\defeq}}\al{56}{2}{ \.{\land}}\al{56}{3}{ pc
 \.{=}\@w{Lbl\_2}}
\fl{ \.{\land}}\al{57}{1}{ {\IF}}\al{57}{2}{ j \.{\leq} Len ( input )}
 \fl{ \.{\THEN}}\al{58}{1}{ \.{\land}}\al{58}{2}{ {\IF}}\al{58}{3}{ ( i
 \.{\neq} j ) \.{\land} ( ( input [ i ] \.{+} input [ j ] ) \.{=} target )}
 \fl{ \.{\THEN}}\al{59}{1}{ \.{\land}}\al{59}{2}{ output \.{'} \.{=} output
 \.{\circ} {\langle} i ,\, j {\rangle}}
\fl{ \.{\ELSE}}\al{60}{1}{ \.{\land}}\al{60}{2}{ {\TRUE}}
\fl{ \.{\land}}\al{61}{1}{ {\UNCHANGED} output}
\fl{ \.{\land}}\al{62}{1}{ j \.{'} \.{=} j \.{+} 1}
\fl{ \.{\land}}\al{63}{1}{ pc \.{'} \.{=}\@w{Lbl\_2}}
\fl{ \.{\land}}\al{64}{1}{ i \.{'}}\al{64}{3}{ \.{=}}\al{64}{4}{ i}
 \fl{ \.{\ELSE}}\al{65}{1}{ \.{\land}}\al{65}{2}{ i \.{'}}\al{65}{4}{
 \.{=}}\al{65}{5}{ i \.{+} 1}
\fl{ \.{\land}}\al{66}{1}{ pc \.{'} \.{=}\@w{Lbl\_1}}
\fl{ \.{\land}}\al{67}{1}{ {\UNCHANGED} {\langle} output ,\, j {\rangle}}
\fl{}
\fl{}
\fl{ Terminating \.{\defeq} pc \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars}
\fl{}
 \fl{ Next}\al{72}{1}{ \.{\defeq}}\al{72}{2}{ Lbl\_1}\al{72}{3}{ \.{\lor}
 Lbl\_2}
\fl{ \.{\lor}}\al{73}{1}{ Terminating}
\fl{}
 \fl{ Spec}\al{75}{1}{ \.{\defeq}}\al{75}{2}{ Init \.{\land} {\Box} [ Next ]_{
 vars}}
\fl{}
