...
--algorithm twoSum {
    ...
    
    {
        ...
        (\A y \in 1..Len(input) : 
        ((x /= y) /\ (input[x] + input[y] = target)) => ((output[1] = input[x]) /\ (output[2] = input[y]))
        ));
    }
}
*)
\* BEGIN TRANSLATION (chksum(pcal) = "1c1979ee" /\ chksum(tla) = "3e883c69")
...
\* Last modified Sun Mar 05 23:44:27 EST 2023 by jorra04
