...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "747769cb" /\ chksum(tla) = "bd5993c6")
...
Lbl_1 == /\ pc = "Lbl_1"
         /\ IF i <= Len(input)
               ...
               ELSE /\ Assert((\A x \in 1..Len(input) :
                              ...
                              "Failure of assertion at line 30, column 2.")
                    /\ pc' = "Done"
                    /\ j' = j
         /\ UNCHANGED << output, i >>
...
\* Last modified Sun Mar 05 23:53:46 EST 2023 by jorra04
