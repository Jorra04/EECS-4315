...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "e60f38aa" /\ chksum(tla) = "76c9525c")
...
Lbl_1 == /\ pc = "Lbl_1"
         /\ Assert((Cardinality({\A x,y \in 1..Len(input) : (input[x] = 3)}) = Cardinality({\A x \in 1..Len(input) : (input[x] = 4)})), 
...
\* Last modified Mon Mar 06 22:12:29 EST 2023 by jorra04
