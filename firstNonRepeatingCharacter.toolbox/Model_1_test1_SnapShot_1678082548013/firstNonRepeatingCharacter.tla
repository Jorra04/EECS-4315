...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "2361f334" /\ chksum(tla) = "74b11977")
...
Lbl_2 == /\ pc = "Lbl_2"
         /\ IF j <= Len(input) /\ duplicateFound = FALSE
               THEN /\ k' = 1
                    /\ pc' = "Lbl_3"
                    /\ UNCHANGED << firstNonRepeating, duplicateFound >>
...
\* Last modified Mon Mar 06 01:02:22 EST 2023 by jorra04
