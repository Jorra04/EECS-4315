...
--algorithm firstNonRepeating {
    ...
    
    {
        ...
        assert (\E x \in 1..Len(input) : (\A y \in 1..Len(input) :
        (x # y) => input[x] # input[y]
        ));
...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "b0f1a290" /\ chksum(tla) = "4eb47b9c")
...
\* Last modified Mon Mar 06 11:26:01 EST 2023 by jorra04
