...
--algorithm keepAll {
    ...
    assert (\A x \in 1..Len(output) : (1 \in output ))
...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "967101a6" /\ chksum(tla) = "d868a0ff")
...
Lbl_2 == /\ pc = "Lbl_2"
         /\ IF i <= Len(input1)
               THEN /\ IF input1[i] /= input2
                    ...
                    /\ i' = i + 1
                    /\ pc' = "Lbl_2"
               ELSE /\ Assert((\A x \in 1..Len(output) : (1 \in output )), 
...
\* Last modified Thu Mar 02 17:57:42 EST 2023 by jorra04
