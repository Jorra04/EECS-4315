...
*)
\* BEGIN TRANSLATION (chksum(pcal) = "d843e2dd" /\ chksum(tla) = "19b6ffb1")
...
Lbl_2 == /\ pc = "Lbl_2"
         /\ IF i <= Len(output)
               THEN /\ IF (i % 2) = 0
                          THEN /\ output' = [output EXCEPT ![i] = evens[evenIndex]]
                               /\ evenIndex' = evenIndex + 1
                               /\ UNCHANGED oddIndex
                          ELSE /\ output' = [output EXCEPT ![i] = odds[oddIndex]]
                               /\ oddIndex' = oddIndex + 1
                               /\ UNCHANGED evenIndex
                    /\ i' = i + 1
                    /\ pc' = "Lbl_2"
...
\* Last modified Sun Apr 02 22:42:29 EDT 2023 by jorra04
